...
image:https://img.shields.io/badge/Provers-48-green.svg[Provers: 48]
image:https://img.shields.io/badge/Tests-613%2B-brightgreen.svg[Tests: 613+]
...
A neurosymbolic theorem proving platform with 48 prover backends,
trust-hardened verification pipeline, and multi-objective proof search.

== Overview

ECHIDNA orchestrates 48 theorem provers, SMT solvers, first-order ATPs, and
...
613+ library tests passing (`cargo test --lib`, 2 ignored).
