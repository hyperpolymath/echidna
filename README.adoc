...
source of truth: link:docs/PROVER_COUNT.md[`+docs/PROVER_COUNT.md+`].
...
minor, what’s targeted next — is link:CHANGELOG.md[`+CHANGELOG.md+`].
...
link:CHANGELOG.md[`+CHANGELOG.md+`] and the git log; not duplicated here
to avoid drift.
