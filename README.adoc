...
image:https://img.shields.io/badge/Provers-12_core_/_67_advertised-green.svg[Provers: 12 core / 67 advertised]
...
(`ProverKind::all()`) is 67 backends. The REST API
...
`ProverKind::all()` advertises a further 55 backends including
