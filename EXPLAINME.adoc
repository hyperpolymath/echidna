...
| **AffineScript /     +
  AffineScript**     | `src/affinescript/`, `src/ui/` — UI components; migration to AffineScript-TEA tracked alongside `affinescript/stdlib` primitives
|===
...
| `src/affinescript/`, `src/ui/` | UI components — migration to AffineScript-TEA in progress
