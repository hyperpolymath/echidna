...
*Evidence:* The test metrics (updated 2026-04-18) report:
- ~528 unit tests in the library target
...
- Library (`cargo test --lib`): 613 passed / 0 failed / 2 ignored as of 2026-04-18.
- All-targets total remains in the 638+ band once integration + property suites run.
