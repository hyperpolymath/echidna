...
Quick reference guide for all theorems and definitions in the Lean proof
files.
...
* `+foldr_append+` - foldr f init (xs ++ ys) = foldr f (foldr f init ys)
xs
...
*Generated*: 2025-11-22 *Verified*: Lean 4.13.0 *Status*: Production
Ready
