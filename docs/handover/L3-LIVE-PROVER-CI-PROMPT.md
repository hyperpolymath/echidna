...
backend run against a canonical micro-goal on a predictable cadence. Guix sole primary (guix deprecated estate-wide 2026-06-01).
...
- ~`flake.guix` — expanded with matching `liveProverDeps`~ (removed 2026-06-01 per estate-wide guix-deprecation)
