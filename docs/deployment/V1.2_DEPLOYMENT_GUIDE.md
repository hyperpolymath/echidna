...
export ECHIDNA_PORT=8081          # API port
...
# ReScript UI
export API_URL=http://localhost:8081  # Backend API
export WS_URL=ws://localhost:8081/ws  # WebSocket
```
