...
- [`docs/handover/PROVER-CORPUS-SATURATION-LANE.adoc`](https://github.com/hyperpolymath/echidna/blob/main/docs/handover/PROVER-CORPUS-SATURATION-LANE.md) — saturation lane handover with sibling-branch collision avoidance.
