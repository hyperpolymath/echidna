...
impl SPASSBackend {
    ...
    fn parse_result(&self, output: &str) -> Result<bool> {
        // SPASS output patterns:
        // - "SPASS beiseite: Proof found." = success
        // - "SPASS beiseite: Completion found." = saturated (depends on context)
            ...
            || output.contains("SPASS beiseite: Proof")
        {
            ...
            // Completion without proof = likely satisfiable
            Ok(false)
        } else {
            Err(anyhow::anyhow!(
                "SPASS inconclusive: {}",
...
impl ProverBackend for SPASSBackend {
    ...
    async fn version(&self) -> Result<String> {
        ...
        // SPASS prints version in output
    ...
    async fn verify_proof(&self, state: &ProofState) -> Result<bool> {
        ...
        let mut child = Command::new(&self.config.executable)
            ...
            .arg("-PGiven=0")  // No proof output
            .arg("-PProblem=0")  // No problem output
            .stdin(Stdio::piped())
            .stdout(Stdio::piped())
            .stderr(Stdio::piped())
            .spawn()
