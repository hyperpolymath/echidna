...
pub struct ACL2Backend { config: ProverConfig }
impl ACL2Backend { pub fn new(config: ProverConfig) -> Self { ACL2Backend { config } } }

#[async_trait]
impl ProverBackend for ACL2Backend {
    fn kind(&self) -> ProverKind { ProverKind::ACL2 }
