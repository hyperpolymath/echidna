...
[.lead]
*Coq-Jr* is a lightweight, browser-native interface for the https://coq.inria.fr[Coq proof assistant], built with AffineScript and Deno. It provides HTTP and GraphQL access to interactive theorem proving, serving as both a standalone proof environment and a satellite component of the https://github.com/hyperpolymath/poly-proof-mcp[poly-proof-mcp] AI-accessible verification network.

[discrete]
== Status: Alpha (v0.2.0-dev)

image:https://img.shields.io/badge/coq-compatible-orange[Coq Compatible]
image:https://img.shields.io/badge/affinescript-v11-red[AffineScript]
...
# Install AffineScript compiler
npm install

# Compile AffineScript sources
npm run res:build
...
[source,bash]
----
# Watch mode for AffineScript compilation
npm run res:dev
...
* *Type safety* — Leverage AffineScript's type system
