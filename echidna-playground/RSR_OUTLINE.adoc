...
* **Infrastructure**: Guix channels, derivations (guix deprecated estate-wide 2026-06-01)
...
* `guix.scm` (guix deprecated estate-wide 2026-06-01; `flake.guix` no longer an acceptable substitute)
