...
* **Infrastructure**: Guix channels, derivations (nix deprecated estate-wide 2026-06-01)
...
* `guix.scm` (nix deprecated estate-wide 2026-06-01; `flake.nix` no longer an acceptable substitute)
