...
(receipts for README claims). Canonical live state: `CHANGELOG.adoc` + the git
log + open issues.
...
. *Stability discipline.* ECHIDNA is *not* affirmed `stable` or `v1.0.0`; the
  real release line is in `CHANGELOG.adoc`.
...
* Stages 5–8 of `docs/ROADMAP.adoc` (distributed, cross-prover semantics,
...
* Prover-count drift across surfaces vs `docs/PROVER_COUNT.adoc` (#251).
